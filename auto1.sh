...
echo $i" |"$cy"     BANGLADESH DARK WEB TURMUX BD HACKER NIROB"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" NURUNNABI ISLAM NIROB  [FR13ND8]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Riski Darmawan"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.P3RC1L] [MR.S∆MAx] [MR.B]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [AldykaPrygh]"$i" |"
echo $i" |"$pu" Contact WhatsApp :"$ku" 017777777777"$i"             |"
echo $i" |"$pu" Facebook Contact  :"$ku" facebook.com/server.error.404.not.found"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
sleep 2
echo $cy"HI I AM NIROB-----FORM BANGLADESH "
sleep 2
echo $i"THIS IS AUTO REPOT COMAND "
sleep 2
echo $ku"WhatsApp :"$i" 0177777777"
echo $ku"Facebook :"$i" www.facebook.com/server.error.404.not.found"
sleep 2
